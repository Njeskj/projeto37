...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $resultado_verificar_email = mysqli_query($conn, $query_verificar_email);

    if ($resultado_verificar_email && mysqli_num_rows($resultado_verificar_email) > 0) {
    ...
    <main class="form-signin w-100 m-auto">
        <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
            ...
            <div class="form-floating">
                <input type="text" class="form-control" id="floatingNome" name="nome" placeholder="Seu Nome" value="<?php echo isset($_POST['nome']) ? $_POST['nome'] : ''; ?>" required>
                <label for="floatingNome">Nome</label>
            </div>
            <div class="form-floating">
                <input type="email" class="form-control" id="floatingEmail" name="email" placeholder="name@example.com" value="<?php echo isset($_POST['email']) ? $_POST['email'] : ''; ?>" required>
                <label for="floatingEmail">Email</label>
            </div>
            <div class="form-floating">
                <input type="password" class="form-control" id="floatingSenha" name="senha" placeholder="Senha" required>
                <label for="floatingSenha">Senha</label>
            </div>

            <button class="btn btn-primary w-100 py-2" type="submit">Cadastrar</button>
            <p><a href="index.php">Início</a> | Já tem uma conta? <a href="login.php">Login</a></p>
            <p class="mt-5 mb-3 text-body-secondary">&copy; 2023 - <?php echo date("Y"); ?> Sistema de Pedidos PHP</p>
        </form>
    </main>
